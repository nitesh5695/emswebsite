...
async function employersdata(){
    ...
    const data= { method:'GET',
        ...
        const res= await  fetch('http://127.0.0.1:7002/user_register/',data)
         .then((res)=> {
                    ...
                    <div class="card bg-light">
                      ...
                      <div class="card-body pt-0">
                        <div class="row">
                          <div class="col-7">
                            ...
                            <p class="text-muted text-sm"><b>User id: </b>${element.user_id} </p>
                      ...
                      <div class="card-footer">
                        <div class="text-right">
                          ...
                          <button id=${element.user_id} class="btn btn-sm btn-primary" onclick="getid(${element.user_id})">
    ...
    function getid(user_id){
        localStorage.setItem("emp_id",user_id)
